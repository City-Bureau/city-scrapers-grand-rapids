...
from city_scrapers.spiders.gra_econ_develop_team import GraEconDevelopTeamSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_econ_develop_team.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraEconDevelopTeamSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_econ_develop_team/202301101230/x/economic_development_project_team"  # noqa
    )
