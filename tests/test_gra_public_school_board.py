...
from city_scrapers.spiders.gra_public_school_board import (  # noqa
    GraPublicSchoolBoardSpider,
)
...
test_response_detail.meta["meeting_id"] = (
    "gra_public_school_board/202405220000/x/special_board_meeting_board_retreat_9_30_a_m_12_00_p_m_"  # noqa
)
...
def test_description():
    assert (
        ...
        == "GRAND RAPIDS PUBLIC SCHOOLS BOARD OF EDUCATION 1400 Fuller Ave. NE Multipurpose Room Grand Rapids, MI 49505 9:30 a.m. - 12:00 p.m. MINUTES STATEMENT Minutes of all Grand Rapids Board of Education meetings are kept on file and are available for inspection at the Board of Education Office of the Grand Rapids Public Schools, 1331 Franklin St. SE, during regular business hours and recent minutes are also accessible via GRPS website at www.grps.org through the BoardDocs link: https://www.boarddocs.com/mi/grand/Board.nsf/vpublic?open"  # noqa
    )
...
def test_location():
    assert parsed_item["location"] == {
        "name": "",
        "address": "BOARD OF EDUCATION, 1400 Fuller Ave. NE, Multipurpose Room, Grand Rapids, MI 49505",  # noqa
    }


def test_source():
    assert (
        parsed_item["source"] == "https://go.boarddocs.com/mi/grand/Board.nsf/Public"
    )  # noqa
