...
from city_scrapers.spiders.grand_rapids_fiscal_committee import (
    GrandRapidsFiscalCommitteeSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_fiscal_committee.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List",
)
spider = GrandRapidsFiscalCommitteeSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_fiscal_committee/202301100830/x/fiscal_committee"
    )
