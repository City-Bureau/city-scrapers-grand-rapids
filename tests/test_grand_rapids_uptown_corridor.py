...
from city_scrapers.spiders.grand_rapids_uptown_corridor import (
    GrandRapidsUptownCorridorSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_uptown_corridor.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List",
)
spider = GrandRapidsUptownCorridorSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_uptown_corridor/202301040800/x/uptown_corridor_improvement_authority"  # noqa
    )
