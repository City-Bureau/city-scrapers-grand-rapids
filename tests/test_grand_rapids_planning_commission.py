...
from city_scrapers.spiders.grand_rapids_planning_commission import (
    GrandRapidsPlanningCommissionSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_planning_commission.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GrandRapidsPlanningCommissionSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_planning_commission/202301121230/x/city_planning_commission"
    )
