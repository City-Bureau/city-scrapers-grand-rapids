...
from city_scrapers.spiders.grand_rapids_historic_preservation import (
    GrandRapidsHistoricPreservationSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_historic_preservation.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List",
)
spider = GrandRapidsHistoricPreservationSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_historic_preservation/202301181700/x/historic_preservation_commission"  # noqa
    )
...
def test_source():
    assert (
        ...
        == "http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List"  # noqa
    )
