...
from city_scrapers.spiders.grand_rapids_public_safety import (
    GrandRapidsPublicSafetySpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_public_safety.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List",
)
spider = GrandRapidsPublicSafetySpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_public_safety/202302071230/x/public_safety_committee"
    )
