...
from city_scrapers.spiders.gra_n_quarter_improvement import GraNQuarterImprovementSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_n_quarter_improvement.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraNQuarterImprovementSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_n_quarter_improvement/202301191600/x/n_quarter_corridor_improvement_authority"  # noqa
    )
