...
from city_scrapers.spiders.gra_uptown_corridor import GraUptownCorridorSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_uptown_corridor.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraUptownCorridorSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_uptown_corridor/202301040800/x/uptown_corridor_improvement_authority"  # noqa
    )
