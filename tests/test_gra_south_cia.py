...
from city_scrapers.spiders.gra_south_cia import GraSouthCiaSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_south_cia.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraSouthCiaSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_south_cia/202302090900/x/south_division_grandville_cia"
    )
