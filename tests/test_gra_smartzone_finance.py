...
from city_scrapers.spiders.gra_smartzone_finance import GraSmartzoneFinanceSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_smartzone_finance.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraSmartzoneFinanceSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_smartzone_finance/202301111030/x/smartzone_local_development_finance_authority"  # noqa
    )
