...
from city_scrapers.spiders.gra_westside_corridor import GraWestsideCorridorSpider

test_response = file_response(
    join(dirname(__file__), "files", "gra_westside_corridor.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx",
)
spider = GraWestsideCorridorSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "gra_westside_corridor/202302030900/x/westside_corridor_improvement_authority"  # noqa
    )
