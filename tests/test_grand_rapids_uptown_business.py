...
from city_scrapers.spiders.grand_rapids_uptown_business import (
    GrandRapidsUptownBusinessSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "grand_rapids_uptown_business.html"),
    url="http://grandrapidscitymi.iqm2.com/Citizens/calendar.aspx?View=List",
)
spider = GrandRapidsUptownBusinessSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "grand_rapids_uptown_business/202301040815/x/uptown_business_improvement_district"  # noqa
    )
