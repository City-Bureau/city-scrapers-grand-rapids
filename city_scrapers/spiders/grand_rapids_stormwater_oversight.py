...
class GrandRapidsStormwaterOversightSpider(CityScrapersSpider):
    name = "grand_rapids_stormwater_oversight"
    agency = "Grand Rapids Stormwater Oversight Commission"
