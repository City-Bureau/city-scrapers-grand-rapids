...
class GrandRapidsCommunityDevelopmentSpider(CityScrapersSpider):
    name = "grand_rapids_community_development"
    agency = "Grand Rapids Community Development Committee"
