...
class GrandRapidsEconomicDevelopmentCorpSpider(CityScrapersSpider):
    name = "grand_rapids_economic_development_corp"
    agency = "Grand Rapids Economic Development Corporation"
