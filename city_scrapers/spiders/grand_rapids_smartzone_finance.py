...
class GrandRapidsSmartzoneFinanceSpider(CityScrapersSpider):
    name = "grand_rapids_smartzone_finance"
    agency = "Grand Rapids SmartZone Local Development Finance Authority"
