...
class GrandRapidsNQuarterImprovementSpider(CityScrapersSpider):
    name = "grand_rapids_n_quarter_improvement"
    agency = "Grand Rapids N. Quarter Corridor Improvement Authority"
    ...
    def parse(self, response):
        ...
        for item in response.css(".MeetingRow"):
            if item.css(".RowTop .RowRight span::text").get() != "Cancelled":
                if (
                    "N. Quarter Corridor Improvement Authority"
