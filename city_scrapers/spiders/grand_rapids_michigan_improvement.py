...
class GrandRapidsMichiganImprovementSpider(CityScrapersSpider):
    name = "grand_rapids_michigan_improvement"
    agency = "Grand Rapids Michigan St. Corridor Improvement Authority"
