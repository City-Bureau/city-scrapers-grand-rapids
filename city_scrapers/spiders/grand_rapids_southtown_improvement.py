...
class GrandRapidsSouthtownImprovementSpider(CityScrapersSpider):
    name = "grand_rapids_southtown_improvement"
    agency = "Grand Rapids Southtown Corridor Improvement Authority"
