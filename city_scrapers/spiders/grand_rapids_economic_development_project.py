...
class GrandRapidsEconomicDevelopmentProjectSpider(CityScrapersSpider):
    name = "grand_rapids_economic_development_project"
    agency = "Grand Rapids Economic Development Project Team"
