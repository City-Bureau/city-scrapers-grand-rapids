...
class GrandRapidsSouthCiaSpider(CityScrapersSpider):
    name = "grand_rapids_south_cia"
    agency = "Grand Rapids South Division-Grandville CIA"
    ...
    def _parse_title(self, item):
        ...
        title = "South Division-Grandville CIA"
        return title
