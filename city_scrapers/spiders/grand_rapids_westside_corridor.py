...
class GrandRapidsWestsideCorridorSpider(CityScrapersSpider):
    name = "grand_rapids_westside_corridor"
    agency = "Grand Rapids Westside Corridor Improvement Authority"
